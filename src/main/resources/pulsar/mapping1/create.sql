...
CREATE TABLE TippersBigTable (
  ...
  INFRASTRUCTURE_TYPE_ID char(255),
  ...
  OBSERVATION_SENSOR_ID char(255),

  SEMANTIC_OBSERVATION_ID char(255),
  SEMANTIC_OBSERVATION_SEMANTIC_ENTITY_ID char(255),
  SEMANTIC_OBSERVATION_occupancy BIGINT ,
  SEMANTIC_OBSERVATION_location char(255) ,
  SEMANTIC_OBSERVATION_TIMESTAMP datetime,
  SEMANTIC_OBSERVATION_VIRTUAL_SENSOR_ID char(255) ,
  SEMANTIC_OBSERVATION_SEMANTIC_OBSERVATION_TYPE_ID char(255),
