...
import edu.uci.ics.tippers.schema.griddb.mappings.SchemaMapping1;

public class GridDBSchema extends BaseSchema {

    private BaseSchemaMapping schemaMapping;
    ...
    public GridDBSchema(int mapping, String dataDir) throws BenchmarkException {
        ...
        switch (mapping) {
            case 1:
                schemaMapping = new SchemaMapping1(gridStore, dataDir);
                break;
            default:
